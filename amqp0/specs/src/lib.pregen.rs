...
/// The file lib.rs is generated with: cargo build --features "amqp0-pregen-specs"

/// The "amqp0-build-specs" feature may be used to disable the use of the pregenerated file
