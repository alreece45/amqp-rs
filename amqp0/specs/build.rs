...
mod spec0_builder {
    ...
    pub fn build() {
        ...
        let out_file = root_out.join("amqp0.rs");
        {
            ...
            writeln!(writer, "/// The file lib.rs is generated with: cargo build --features \"amqp0-pregen-specs\" \n").unwrap();
            writeln!(writer, "/// The \"amqp0-build-specs\" feature may be used to disable the use of the pregenerated file\n").unwrap();
