...
#[cfg(any(feature = "amqp0-build-primitives", feature = "amqp-pregen-primitives"))]
...
#[cfg(not(any(feature = "amqp0-build-primitives", feature = "amqp-pregen-primitives")))]
mod amqp0 {
    pub fn build() {
        println!("Skipping build (neither amqp0-build-primitives nor amqp-pregen-primitives specified)");
    }
}
...
mod amqp0 {
        ...
        where W: io::Write
    {
        ...
        writeln!(writer, "/// The \"amqp0-build-primitives\" feature may be used to disable the use of the pregenerated file").unwrap();
