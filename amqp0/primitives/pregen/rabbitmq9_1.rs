...
// generated by primalgen::codegen::spec_module::class_mod::ClassModuleWriter
pub mod connection {
    impl<'a> ::method::connection::BlockedMethod<'a> for ::Rabbitmq9_1 {
        type Payload = Blocked<'a>;
    } // impl<'a> ::method::connection::BlockedMethod<'a> for ::Rabbitmq9_1
    ...
    impl<'a> Blocked<'a> {
        pub fn new<R>(reason: R) -> Self
            where R: Into<::std::borrow::Cow<'a, str>>
        {
            Blocked { reason: reason.into() } // Blocked
        } // fn new()
        impl_properties! {
(reason, reason_mut, set_reason) -> Cow<str>,
} // impl_properties
    } // impl<'a> Blocked<'a>
    impl<'a> Default for Blocked<'a> {
        fn default() -> Self {
            Blocked::new("")
        } // fn default()
    ...
    impl<'a> ::method::connection::CloseMethod<'a> for ::Rabbitmq9_1 {
        type Payload = Close<'a>;
    } // impl<'a> ::method::connection::CloseMethod<'a> for ::Rabbitmq9_1
...
(method_id, set_method_id) -> u16,
    ...
    impl ::method::connection::CloseOkMethod for ::Rabbitmq9_1 {
        type Payload = CloseOk;
    } // impl ::method::connection::CloseOkMethod for ::Rabbitmq9_1
    ...
    impl<'a> ::method::connection::OpenMethod<'a> for ::Rabbitmq9_1 {
        type Payload = Open<'a>;
    } // impl<'a> ::method::connection::OpenMethod<'a> for ::Rabbitmq9_1
...
(virtual_host, virtual_host_mut, set_virtual_host) -> Cow<str>,
    ...
    impl<'a> ::method::connection::OpenOkMethod<'a> for ::Rabbitmq9_1 {
        type Payload = OpenOk;
    } // impl<'a> ::method::connection::OpenOkMethod<'a> for ::Rabbitmq9_1
    ...
    impl<'a> ::method::connection::SecureMethod<'a> for ::Rabbitmq9_1 {
...
(challenge, challenge_mut, set_challenge) -> Cow<[u8]>,
    ...
    impl<'a> ::method::connection::SecureOkMethod<'a> for ::Rabbitmq9_1 {
...
(response, response_mut, set_response) -> Cow<[u8]>,
    ...
    impl<'a> ::method::connection::StartMethod<'a> for ::Rabbitmq9_1 {
...
(locales, locales_mut, set_locales) -> Cow<[u8]>,
    ...
    impl<'a> ::method::connection::StartOkMethod<'a> for ::Rabbitmq9_1 {
...
(locale, locale_mut, set_locale) -> Cow<str>,
    ...
    impl ::method::connection::TuneMethod for ::Rabbitmq9_1 {
        type Payload = Tune;
    } // impl ::method::connection::TuneMethod for ::Rabbitmq9_1
...
(heartbeat, set_heartbeat) -> u16,
    ...
    impl ::method::connection::TuneOkMethod for ::Rabbitmq9_1 {
        type Payload = TuneOk;
    } // impl ::method::connection::TuneOkMethod for ::Rabbitmq9_1
...
(heartbeat, set_heartbeat) -> u16,
    ...
    impl ::method::connection::UnblockedMethod for ::Rabbitmq9_1 {
        type Payload = Unblocked;
    } // impl ::method::connection::UnblockedMethod for ::Rabbitmq9_1
    ...
    impl<'a> ::Encodable for ClassMethod<'a> {
        fn encoded_size(&self) -> usize {
            match *self {
                ClassMethod::Blocked(ref method) => ::Encodable::encoded_size(method),
                ClassMethod::Close(ref method) => ::Encodable::encoded_size(method),
                ClassMethod::CloseOk(ref method) => ::Encodable::encoded_size(method),
                ClassMethod::Open(ref method) => ::Encodable::encoded_size(method),
                ClassMethod::OpenOk(ref method) => ::Encodable::encoded_size(method),
                ...
                ClassMethod::Unblocked(ref method) => ::Encodable::encoded_size(method),
    ...
    impl<'a> ::ProtocolMethodPayload for ClassMethod<'a> {
        fn class_id(&self) -> u16 {
            match *self {
                ...
                ClassMethod::Unblocked(ref method) => ::ProtocolMethodPayload::class_id(method),
        ...
        fn method_id(&self) -> u16 {
            match *self {
                ...
                ClassMethod::Unblocked(ref method) => ::ProtocolMethodPayload::method_id(method),
    ...
    impl<'a> ::Encodable for Bind<'a> {
        fn encoded_size(&self) -> usize {
            [6,
             ...
             ::Encodable::encoded_size(&self.source),
             ::Encodable::encoded_size(&self.routing_key),
             ::Encodable::encoded_size(&self.arguments)]
                .iter()
                .sum()
...
// generated by primalgen::codegen::spec_module::class_mod::ClassModuleWriter
pub mod queue {
    impl<'a> ::method::queue::BindMethod<'a> for ::Rabbitmq9_1 {
        type Payload = Bind<'a>;
    } // impl<'a> ::method::queue::BindMethod<'a> for ::Rabbitmq9_1
...
(arguments, arguments_mut, set_arguments) -> &::field::TableEntries<'a>,
    ...
    impl ::method::queue::BindOkMethod for ::Rabbitmq9_1 {
        type Payload = BindOk;
    } // impl ::method::queue::BindOkMethod for ::Rabbitmq9_1
    ...
    impl<'a> ::method::queue::DeclareMethod<'a> for ::Rabbitmq9_1 {
        type Payload = Declare<'a>;
    } // impl<'a> ::method::queue::DeclareMethod<'a> for ::Rabbitmq9_1
...
(arguments, arguments_mut, set_arguments) -> &::field::TableEntries<'a>,
    ...
    impl<'a> ::method::queue::DeclareOkMethod<'a> for ::Rabbitmq9_1 {
...
(consumer_count, set_consumer_count) -> u32,
    ...
    impl<'a> ::method::queue::DeleteMethod<'a> for ::Rabbitmq9_1 {
        type Payload = Delete<'a>;
    } // impl<'a> ::method::queue::DeleteMethod<'a> for ::Rabbitmq9_1
...
(no_wait, set_no_wait) -> bool,
    ...
    impl ::method::queue::DeleteOkMethod for ::Rabbitmq9_1 {
        type Payload = DeleteOk;
    } // impl ::method::queue::DeleteOkMethod for ::Rabbitmq9_1
...
(message_count, set_message_count) -> u32,
    ...
    impl<'a> ::method::queue::PurgeMethod<'a> for ::Rabbitmq9_1 {
...
(no_wait, set_no_wait) -> bool,
    ...
    impl ::method::queue::PurgeOkMethod for ::Rabbitmq9_1 {
...
(message_count, set_message_count) -> u32,
    ...
    impl<'a> ::method::queue::UnbindMethod<'a> for ::Rabbitmq9_1 {
        type Payload = Unbind<'a>;
    } // impl<'a> ::method::queue::UnbindMethod<'a> for ::Rabbitmq9_1
...
(arguments, arguments_mut, set_arguments) -> &::field::TableEntries<'a>,
    ...
    impl ::method::queue::UnbindOkMethod for ::Rabbitmq9_1 {
        type Payload = UnbindOk;
    } // impl ::method::queue::UnbindOkMethod for ::Rabbitmq9_1
...
// generated by primalgen::codegen::spec_module::class_mod::ClassModuleWriter
pub mod tx {
    impl ::method::tx::CommitMethod for ::Rabbitmq9_1 {
        type Payload = Commit;
    } // impl ::method::tx::CommitMethod for ::Rabbitmq9_1
    ...
    impl ::method::tx::CommitOkMethod for ::Rabbitmq9_1 {
    ...
    impl ::method::tx::RollbackMethod for ::Rabbitmq9_1 {
    ...
    impl ::method::tx::RollbackOkMethod for ::Rabbitmq9_1 {
    ...
    impl ::method::tx::SelectMethod for ::Rabbitmq9_1 {
        type Payload = Select;
    } // impl ::method::tx::SelectMethod for ::Rabbitmq9_1
    ...
    impl ::method::tx::SelectOkMethod for ::Rabbitmq9_1 {
        type Payload = SelectOk;
    } // impl ::method::tx::SelectOkMethod for ::Rabbitmq9_1
...
pub use self::confirm::ClassMethod as ConfirmMethod;
...
impl<'a> ::Encodable for SpecMethod<'a> {
    fn encoded_size(&self) -> usize {
        match *self {
            ...
            SpecMethod::Confirm(ref method) => ::Encodable::encoded_size(method),
...
impl<'a> ::ProtocolMethodPayload for SpecMethod<'a> {
    fn class_id(&self) -> u16 {
        match *self {
            ...
            SpecMethod::Confirm(ref method) => ::ProtocolMethodPayload::class_id(method),
    ...
    fn method_id(&self) -> u16 {
        match *self {
            ...
            SpecMethod::Confirm(ref method) => ::ProtocolMethodPayload::method_id(method),
