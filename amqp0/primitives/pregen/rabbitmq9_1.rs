...
pub mod basic {
    ...
    impl<'a> Deliver<'a> {
        pub fn new<E, C, R>(consumer_tag: C,
                            delivery_tag: u64,
                            redelivered: bool,
                            exchange: E,
                            routing_key: R)
...
pub mod connection {
    ...
    impl<'a> Start<'a> {
        pub fn new<M, L, S>(version_major: u8,
                            version_minor: u8,
                            server_properties: S,
                            mechanisms: M,
                            locales: L)
...
pub mod exchange {
    ...
    impl<'a> Bind<'a> {
        pub fn new<S, R, D, A>(destination: D,
                               source: S,
                               routing_key: R,
                               no_wait: bool,
                               arguments: A)
    ...
    impl<'a> Unbind<'a> {
        pub fn new<A, R, S, D>(destination: D,
                               source: S,
                               routing_key: R,
                               no_wait: bool,
                               arguments: A)
...
pub mod queue {
    ...
    impl<'a> Unbind<'a> {
        pub fn new<E, R, A, Q>(queue: Q, exchange: E, routing_key: R, arguments: A) -> Self
            where Q: Into<::std::borrow::Cow<'a, str>>,
                  E: Into<::std::borrow::Cow<'a, str>>,
                  R: Into<::std::borrow::Cow<'a, str>>,
                  A: Into<::std::borrow::Cow<'a, ::field::Table<'a>>>
