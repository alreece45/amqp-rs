...
pub mod connection {
    ...
    impl<'a> Start<'a> {
        pub fn new<L, S, M>(version_major: u8,
                            version_minor: u8,
                            server_properties: S,
                            mechanisms: M,
                            locales: L)
    ...
    impl<'a> StartOk<'a> {
        pub fn new<C, L, M, R>(client_properties: C, mechanism: M, response: R, locale: L) -> Self
...
pub mod exchange {
    ...
    impl<'a> Bound<'a> {
        pub fn new<Q, R, E>(exchange: E, routing_key: R, queue: Q) -> Self
            where E: Into<::std::borrow::Cow<'a, str>>,
                  R: Into<::std::borrow::Cow<'a, str>>,
...
pub mod file {
    ...
    impl<'a> Deliver<'a> {
        pub fn new<E, R, I, C>(consumer_tag: C,
                               delivery_tag: u64,
                               redelivered: bool,
                               exchange: E,
                               routing_key: R,
...
pub mod message {
    ...
    impl<'a> Transfer<'a> {
        pub fn new<C0, C1, U, R, C, A, S, R0, D, E, A0, B, M, T>(ticket: u16,
                                                                 destination: D,
                                                                 redelivered: bool,
                                                                 immediate: bool,
                                                                 ttl: u64,
...
pub mod stream {
    ...
    impl<'a> Return<'a> {
        pub fn new<R, R0, E>(reply_code: u16, reply_text: R, exchange: E, routing_key: R0) -> Self
            where R: Into<::std::borrow::Cow<'a, str>>,
                  E: Into<::std::borrow::Cow<'a, str>>,
                  R0: Into<::std::borrow::Cow<'a, str>>
        {
    ...
    impl<'a> Deliver<'a> {
        pub fn new<E, C, Q>(consumer_tag: C, delivery_tag: u64, exchange: E, queue: Q) -> Self
            where C: Into<::std::borrow::Cow<'a, str>>,
                  E: Into<::std::borrow::Cow<'a, str>>,
                  Q: Into<::std::borrow::Cow<'a, str>>
        {
