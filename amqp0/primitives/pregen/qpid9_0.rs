    ...
    impl<'a> ::ProtocolMethodPayload for ClassMethod<'a> {
        ...
        fn method_id(&self) -> u16 {
            match *self {
                ...
                ClassMethod::RecoverSyncOk(ref method) => {
                    ::ProtocolMethodPayload::method_id(method)
                }
...
// generated by primalgen::codegen::spec_module::class_mod::ClassModuleWriter
pub mod channel {
    impl<'a> ::method::channel::CloseMethod<'a> for ::Qpid9_0 {
...
(channel_id, channel_id_mut, set_channel_id) -> Cow<[u8]>,
    ...
    impl<'a> ::Encodable for OpenOk<'a> {
        fn encoded_size(&self) -> usize {
            [2, ::Encodable::encoded_size(&self.channel_id)]
                .iter()
                .sum()
        } // fn encoded_size()
    } // impl Encodable
...
(reply_text, reply_text_mut, set_reply_text) -> Cow<str>,
    ...
    impl<'a> ::Encodable for BoundOk<'a> {
        fn encoded_size(&self) -> usize {
            [3, ::Encodable::encoded_size(&self.reply_text)]
                .iter()
                .sum()
        } // fn encoded_size()
    } // impl Encodable
...
(identifier, identifier_mut, set_identifier) -> Cow<str>,
    ...
    impl<'a> ::Encodable for Checkpoint<'a> {
        fn encoded_size(&self) -> usize {
            [3,
             ::Encodable::encoded_size(&self.reference),
             ::Encodable::encoded_size(&self.identifier)]
                .iter()
                .sum()
        } // fn encoded_size()
...
(timestamp, timestamp_mut, set_timestamp, take_timestamp) -> Option< u64 >,
    ...
    impl<'a> ::method::stream::CancelMethod<'a> for ::Qpid9_0 {
        type Payload = Cancel<'a>;
    } // impl<'a> ::method::stream::CancelMethod<'a> for ::Qpid9_0
...
(no_wait, set_no_wait) -> bool,
    ...
    impl<'a> ::method::stream::CancelOkMethod<'a> for ::Qpid9_0 {
        type Payload = CancelOk<'a>;
    } // impl<'a> ::method::stream::CancelOkMethod<'a> for ::Qpid9_0
...
(consumer_tag, consumer_tag_mut, set_consumer_tag) -> Cow<str>,
    ...
    impl<'a> ::method::stream::ConsumeMethod<'a> for ::Qpid9_0 {
        type Payload = Consume<'a>;
    } // impl<'a> ::method::stream::ConsumeMethod<'a> for ::Qpid9_0
...
(filter, filter_mut, set_filter) -> &::field::TableEntries<'a>,
    ...
    impl<'a> ::method::stream::ConsumeOkMethod<'a> for ::Qpid9_0 {
        type Payload = ConsumeOk<'a>;
    } // impl<'a> ::method::stream::ConsumeOkMethod<'a> for ::Qpid9_0
...
(consumer_tag, consumer_tag_mut, set_consumer_tag) -> Cow<str>,
    ...
    impl<'a> ::method::stream::DeliverMethod<'a> for ::Qpid9_0 {
        type Payload = Deliver<'a>;
    } // impl<'a> ::method::stream::DeliverMethod<'a> for ::Qpid9_0
...
(queue, queue_mut, set_queue) -> Cow<str>,
    ...
    impl<'a> ::method::stream::PublishMethod<'a> for ::Qpid9_0 {
        type Payload = Publish<'a>;
    } // impl<'a> ::method::stream::PublishMethod<'a> for ::Qpid9_0
...
(immediate, set_immediate) -> bool,
    ...
    impl ::method::stream::QosMethod for ::Qpid9_0 {
        type Payload = Qos;
    } // impl ::method::stream::QosMethod for ::Qpid9_0
...
(global, set_global) -> bool,
    ...
    impl ::method::stream::QosOkMethod for ::Qpid9_0 {
        type Payload = QosOk;
    } // impl ::method::stream::QosOkMethod for ::Qpid9_0
    ...
    impl<'a> ::method::stream::ReturnMethod<'a> for ::Qpid9_0 {
        type Payload = Return<'a>;
    } // impl<'a> ::method::stream::ReturnMethod<'a> for ::Qpid9_0
...
(broadcast, broadcast_mut, set_broadcast, take_broadcast) -> Option< u8 >,
    ...
    impl<'a> ::method::tunnel::RequestMethod<'a> for ::Qpid9_0 {
        type Payload = Request<'a>;
    } // impl<'a> ::method::tunnel::RequestMethod<'a> for ::Qpid9_0
