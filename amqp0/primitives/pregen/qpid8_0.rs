...
// generated by primalgen::codegen::spec_module::class_mod::ClassModuleWriter
pub mod connection {
    impl<'a> ::method::connection::CloseMethod<'a> for ::Qpid8_0 {
        type Payload = Close<'a>;
    } // impl<'a> ::method::connection::CloseMethod<'a> for ::Qpid8_0
...
// generated by primalgen::codegen::spec_module::class_mod::ClassModuleWriter
pub mod dtx {
    impl ::method::dtx::SelectMethod for ::Qpid8_0 {
        type Payload = Select;
    } // impl ::method::dtx::SelectMethod for ::Qpid8_0
...
// generated by primalgen::codegen::spec_module::class_mod::ClassModuleWriter
pub mod exchange {
    impl<'a> ::method::exchange::BoundMethod<'a> for ::Qpid8_0 {
...
(timestamp, timestamp_mut, set_timestamp, take_timestamp) -> Option< u64 >,
    ...
    impl<'a> ::method::stream::CancelMethod<'a> for ::Qpid8_0 {
        type Payload = Cancel<'a>;
    } // impl<'a> ::method::stream::CancelMethod<'a> for ::Qpid8_0
...
(no_wait, set_no_wait) -> bool,
    ...
    impl<'a> ::method::stream::CancelOkMethod<'a> for ::Qpid8_0 {
        type Payload = CancelOk<'a>;
    } // impl<'a> ::method::stream::CancelOkMethod<'a> for ::Qpid8_0
...
(consumer_tag, consumer_tag_mut, set_consumer_tag) -> Cow<str>,
    ...
    impl<'a> ::method::stream::ConsumeMethod<'a> for ::Qpid8_0 {
        type Payload = Consume<'a>;
    } // impl<'a> ::method::stream::ConsumeMethod<'a> for ::Qpid8_0
...
(no_wait, set_no_wait) -> bool,
    ...
    impl<'a> ::method::stream::ConsumeOkMethod<'a> for ::Qpid8_0 {
        type Payload = ConsumeOk<'a>;
    } // impl<'a> ::method::stream::ConsumeOkMethod<'a> for ::Qpid8_0
...
(consumer_tag, consumer_tag_mut, set_consumer_tag) -> Cow<str>,
    ...
    impl<'a> ::method::stream::DeliverMethod<'a> for ::Qpid8_0 {
        type Payload = Deliver<'a>;
    } // impl<'a> ::method::stream::DeliverMethod<'a> for ::Qpid8_0
...
(queue, queue_mut, set_queue) -> Cow<str>,
    ...
    impl<'a> ::method::stream::PublishMethod<'a> for ::Qpid8_0 {
        type Payload = Publish<'a>;
    } // impl<'a> ::method::stream::PublishMethod<'a> for ::Qpid8_0
...
(immediate, set_immediate) -> bool,
    ...
    impl ::method::stream::QosMethod for ::Qpid8_0 {
        type Payload = Qos;
    } // impl ::method::stream::QosMethod for ::Qpid8_0
...
(global, set_global) -> bool,
    ...
    impl ::method::stream::QosOkMethod for ::Qpid8_0 {
        type Payload = QosOk;
    } // impl ::method::stream::QosOkMethod for ::Qpid8_0
    ...
    impl<'a> ::method::stream::ReturnMethod<'a> for ::Qpid8_0 {
        type Payload = Return<'a>;
    } // impl<'a> ::method::stream::ReturnMethod<'a> for ::Qpid8_0
...
// generated by primalgen::codegen::spec_module::class_mod::ClassModuleWriter
pub mod tx {
    impl ::method::tx::CommitMethod for ::Qpid8_0 {
        type Payload = Commit;
    } // impl ::method::tx::CommitMethod for ::Qpid8_0
