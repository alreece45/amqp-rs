...
impl<'a> ::Encodable for Properties<'a> {
    fn encoded_size(&self) -> usize {
        ...
        ::Encodable::encoded_size(&self.timestamp) +
...
impl ::method::file::AckMethod for ::Qpid8_0 {
    type Payload = Ack;
} // impl ::method::file::AckMethod for ::Qpid8_0
...
impl From<Ack> for super::SpecMethod<'static> {
    fn from(from: Ack) -> Self {
        super::SpecMethod::File(from.into())
    } // fn default()
} // impl From<Ack> for ::super::SpecMethod
impl<'a> ::method::file::CancelMethod<'a> for ::Qpid8_0 {
...
impl<'a> ::method::file::CancelOkMethod<'a> for ::Qpid8_0 {
...
impl<'a> ::method::file::ConsumeMethod<'a> for ::Qpid8_0 {
...
impl<'a> ::method::file::ConsumeOkMethod<'a> for ::Qpid8_0 {
...
impl<'a> ::method::file::DeliverMethod<'a> for ::Qpid8_0 {
...
impl<'a> ::method::file::OpenMethod<'a> for ::Qpid8_0 {
    type Payload = Open<'a>;
} // impl<'a> ::method::file::OpenMethod<'a> for ::Qpid8_0
...
impl<'a> ::Encodable for Open<'a> {
    ...
    {
        try!(::Encodable::write_encoded_to(&self.identifier, writer)); // identifier
        try!(::Encodable::write_encoded_to(&self.content_size, writer)); // content_size
...
impl ::method::file::OpenOkMethod for ::Qpid8_0 {
    type Payload = OpenOk;
} // impl ::method::file::OpenOkMethod for ::Qpid8_0
...
impl ::Encodable for OpenOk {
    ...
    fn write_encoded_to<W>(&self, writer: &mut W) -> ::std::io::Result<()>
        where W: ::std::io::Write
    {
        try!(::Encodable::write_encoded_to(&self.staged_size, writer)); // staged_size
...
impl<'a> ::method::file::PublishMethod<'a> for ::Qpid8_0 {
...
impl ::method::file::QosMethod for ::Qpid8_0 {
    type Payload = Qos;
} // impl ::method::file::QosMethod for ::Qpid8_0
...
impl ::method::file::QosOkMethod for ::Qpid8_0 {
    type Payload = QosOk;
} // impl ::method::file::QosOkMethod for ::Qpid8_0
...
impl ::method::file::RejectMethod for ::Qpid8_0 {
    type Payload = Reject;
} // impl ::method::file::RejectMethod for ::Qpid8_0
...
impl<'a> ::method::file::ReturnMethod<'a> for ::Qpid8_0 {
...
impl<'a> ::method::file::StageMethod<'a> for ::Qpid8_0 {
    type Payload = Stage;
} // impl<'a> ::method::file::StageMethod<'a> for ::Qpid8_0
...
#[test]
fn test_stage_encodable_bytes_written_matches_len() {
    let payload: Stage = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
impl<'a> ::method::file::SetStageMethodFields<'a> for Stage {} // impl<'a> ::method::file::SetStageMethodFields<'a> for Stage
impl<'a> From<Stage> for ClassMethod<'a> {
    fn from(from: Stage) -> Self {
        ClassMethod::Stage(from)
    } // fn from()
} // impl From<Stage> for ClassMethod

impl From<Stage> for super::SpecMethod<'static> {
    fn from(from: Stage) -> Self {
        super::SpecMethod::File(from.into())
    } // fn default()
} // impl From<Stage> for ::super::SpecMethod
...
impl<'a> ::ProtocolMethodPayload for ClassMethod<'a> {
    fn class(&self) -> ::Class {
        match *self {
            ...
            ClassMethod::Stage(ref method) => ::ProtocolMethodPayload::class(method),
    ...
    fn class_name(&self) -> &'static str {
        match *self {
            ...
            ClassMethod::Stage(ref method) => ::ProtocolMethodPayload::class_name(method),
    ...
    fn method_name(&self) -> &'static str {
        match *self {
            ...
            ClassMethod::Stage(ref method) => ::ProtocolMethodPayload::method_name(method),
