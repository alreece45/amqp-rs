...
impl<'a> ::method::test::ContentMethod<'a> for ::Qpid8_0 {
...
impl<'a> ::method::test::ContentOkMethod<'a> for ::Qpid8_0 {
...
impl<'a> ::Content<'a> for ContentOk {
    type Headers = ();
}
...
impl<'a> ::method::test::SetContentOkMethodFields<'a> for ContentOk {
