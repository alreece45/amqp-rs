...
impl<'a> Properties<'a> {
    fn flag_bits(&self) -> ::bit_vec::BitVec {
        ...
        flags.set(13, self.reserved.is_some());
        flags
    } // fn flag_bits()
    impl_properties! {
...
impl<'a> ::Encodable for Properties<'a> {
    fn encoded_size(&self) -> usize {
        ...
        ::Encodable::encoded_size(&self.app_id) + ::Encodable::encoded_size(&self.reserved)
    } // encoded_size
        ...
        where W: ::std::io::Write
    {
        ...
        try!(::Encodable::write_encoded_to(&self.reserved, writer));
...
} // impl From<GetEmpty> for ClassMethod

impl From<GetEmpty> for super::SpecMethod<'static> {
    fn from(from: GetEmpty) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<GetEmpty> for ::super::SpecMethod
...
#[test]
fn test_recover_async_encodable_bytes_written_matches_len() {
    let payload: RecoverAsync = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
impl<'a> From<RecoverAsync> for ClassMethod<'a> {
    fn from(from: RecoverAsync) -> Self {
        ClassMethod::RecoverAsync(from)
    } // fn from()
} // impl From<RecoverAsync> for ClassMethod

impl From<RecoverAsync> for super::SpecMethod<'static> {
    fn from(from: RecoverAsync) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<RecoverAsync> for ::super::SpecMethod
...
#[test]
fn test_recover_ok_encodable_bytes_written_matches_len() {
    let payload: RecoverOk = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
} // impl From<RecoverOk> for ClassMethod

impl From<RecoverOk> for super::SpecMethod<'static> {
    fn from(from: RecoverOk) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<RecoverOk> for ::super::SpecMethod
