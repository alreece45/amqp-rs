...
pub mod access {
    impl<'a> ::method::access::RequestMethod<'a> for ::Amqp9_0 {
...
(read, set_read) -> bool,
    ...
    impl ::method::access::RequestOkMethod for ::Amqp9_0 {
...
// generated by primalgen::codegen::spec_module::class_mod::ClassModuleWriter
pub mod connection {
    impl<'a> ::method::connection::CloseMethod<'a> for ::Amqp9_0 {
        type Payload = Close<'a>;
    } // impl<'a> ::method::connection::CloseMethod<'a> for ::Amqp9_0
...
(method_id, set_method_id) -> u16,
    ...
    impl ::method::connection::CloseOkMethod for ::Amqp9_0 {
        type Payload = CloseOk;
    } // impl ::method::connection::CloseOkMethod for ::Amqp9_0
    ...
    impl<'a> ::method::connection::OpenMethod<'a> for ::Amqp9_0 {
        type Payload = Open<'a>;
    } // impl<'a> ::method::connection::OpenMethod<'a> for ::Amqp9_0
...
(insist, set_insist) -> bool,
    ...
    impl<'a> ::method::connection::OpenOkMethod<'a> for ::Amqp9_0 {
        type Payload = OpenOk<'a>;
    } // impl<'a> ::method::connection::OpenOkMethod<'a> for ::Amqp9_0
...
(known_hosts, known_hosts_mut, set_known_hosts) -> Cow<str>,
    ...
    impl<'a> ::method::connection::RedirectMethod<'a> for ::Amqp9_0 {
...
(known_hosts, known_hosts_mut, set_known_hosts) -> Cow<str>,
    ...
    impl<'a> ::method::connection::SecureMethod<'a> for ::Amqp9_0 {
...
(challenge, challenge_mut, set_challenge) -> Cow<[u8]>,
    ...
    impl<'a> ::method::connection::SecureOkMethod<'a> for ::Amqp9_0 {
...
(response, response_mut, set_response) -> Cow<[u8]>,
    ...
    impl<'a> ::method::connection::StartMethod<'a> for ::Amqp9_0 {
...
(locales, locales_mut, set_locales) -> Cow<[u8]>,
    ...
    impl<'a> ::method::connection::StartOkMethod<'a> for ::Amqp9_0 {
...
(locale, locale_mut, set_locale) -> Cow<str>,
    ...
    impl ::method::connection::TuneMethod for ::Amqp9_0 {
        type Payload = Tune;
    } // impl ::method::connection::TuneMethod for ::Amqp9_0
...
(heartbeat, set_heartbeat) -> u16,
    ...
    impl ::method::connection::TuneOkMethod for ::Amqp9_0 {
        type Payload = TuneOk;
    } // impl ::method::connection::TuneOkMethod for ::Amqp9_0
...
// generated by primalgen::codegen::spec_module::class_mod::ClassModuleWriter
pub mod dtx {
    impl ::method::dtx::SelectMethod for ::Amqp9_0 {
        type Payload = Select;
    } // impl ::method::dtx::SelectMethod for ::Amqp9_0
    ...
    impl ::method::dtx::SelectOkMethod for ::Amqp9_0 {
    ...
    impl<'a> ::method::dtx::StartMethod<'a> for ::Amqp9_0 {
        type Payload = Start<'a>;
    } // impl<'a> ::method::dtx::StartMethod<'a> for ::Amqp9_0
...
(dtx_identifier, dtx_identifier_mut, set_dtx_identifier) -> Cow<str>,
    ...
    impl ::method::dtx::StartOkMethod for ::Amqp9_0 {
...
// generated by primalgen::codegen::spec_module::class_mod::ClassModuleWriter
pub mod exchange {
    impl<'a> ::method::exchange::DeclareMethod<'a> for ::Amqp9_0 {
