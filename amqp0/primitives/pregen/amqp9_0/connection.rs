...
} // impl ::ProtocolMethodPayload for Redirect<'a>
...
impl<'a> ::ProtocolMethodPayload for ClassMethod<'a> {
    fn class(&self) -> ::Class {
        match *self {
            ...
            ClassMethod::Redirect(ref method) => ::ProtocolMethodPayload::class(method),
    ...
    fn class_name(&self) -> &'static str {
        match *self {
            ...
            ClassMethod::Redirect(ref method) => ::ProtocolMethodPayload::class_name(method),
    ...
    fn method_name(&self) -> &'static str {
        match *self {
            ...
            ClassMethod::Redirect(ref method) => ::ProtocolMethodPayload::method_name(method),
