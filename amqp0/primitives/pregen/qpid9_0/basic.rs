...
impl<'a> Properties<'a> {
    fn flag_bits(&self) -> ::bit_vec::BitVec {
        ...
        flags.set(3, self.delivery_mode.is_some());
        flags.set(4, self.priority.is_some());
        flags.set(5, self.correlation_id.is_some());
        flags.set(6, self.reply_to.is_some());
        flags.set(7, self.expiration.is_some());
        flags.set(8, self.message_id.is_some());
        flags.set(9, self.timestamp.is_some());
        flags.set(10, self.ty.is_some());
        flags.set(11, self.user_id.is_some());
        flags.set(12, self.app_id.is_some());
        flags.set(13, self.cluster_id.is_some());
        flags
    } // fn flag_bits()
    impl_properties! {
...
impl<'a> ::Encodable for Properties<'a> {
    fn encoded_size(&self) -> usize {
        2 + ::Encodable::encoded_size(&self.content_type) +
        ::Encodable::encoded_size(&self.content_encoding) +
        ::Encodable::encoded_size(&self.headers) +
        ::Encodable::encoded_size(&self.delivery_mode) +
        ::Encodable::encoded_size(&self.priority) +
        ::Encodable::encoded_size(&self.correlation_id) +
        ::Encodable::encoded_size(&self.reply_to) +
        ::Encodable::encoded_size(&self.expiration) +
        ::Encodable::encoded_size(&self.message_id) +
        ::Encodable::encoded_size(&self.timestamp) + ::Encodable::encoded_size(&self.ty) +
        ...
        where W: ::std::io::Write
    {
        ...
        try!(::Encodable::write_encoded_to(&self.delivery_mode, writer));
        try!(::Encodable::write_encoded_to(&self.priority, writer));
        try!(::Encodable::write_encoded_to(&self.correlation_id, writer));
        try!(::Encodable::write_encoded_to(&self.reply_to, writer));
        try!(::Encodable::write_encoded_to(&self.expiration, writer));
        ...
        try!(::Encodable::write_encoded_to(&self.user_id, writer));
        try!(::Encodable::write_encoded_to(&self.app_id, writer));
...
impl ::method::basic::AckMethod for ::Qpid9_0 {
    type Payload = Ack;
} // impl ::method::basic::AckMethod for ::Qpid9_0
...
#[test]
fn test_ack_encodable_bytes_written_matches_len() {
    let payload: Ack = Default::default();
...
impl<'a> From<Ack> for ClassMethod<'a> {
    fn from(from: Ack) -> Self {
        ClassMethod::Ack(from)
    } // fn from()
} // impl From<Ack> for ClassMethod

impl From<Ack> for super::SpecMethod<'static> {
    fn from(from: Ack) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<Ack> for ::super::SpecMethod
impl<'a> ::method::basic::CancelMethod<'a> for ::Qpid9_0 {
...
impl<'a> ::method::basic::CancelOkMethod<'a> for ::Qpid9_0 {
...
impl<'a> From<CancelOk<'a>> for ClassMethod<'a> {
    fn from(from: CancelOk<'a>) -> Self {
        ClassMethod::CancelOk(from)
    } // fn from()
} // impl From<CancelOk<'a>> for ClassMethod

impl<'a> From<CancelOk<'a>> for super::SpecMethod<'a> {
    fn from(from: CancelOk<'a>) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<CancelOk<'a>> for ::super::SpecMethod
impl<'a> ::method::basic::ConsumeMethod<'a> for ::Qpid9_0 {
...
impl<'a> ::method::basic::ConsumeOkMethod<'a> for ::Qpid9_0 {
...
impl<'a> From<ConsumeOk<'a>> for ClassMethod<'a> {
    fn from(from: ConsumeOk<'a>) -> Self {
        ClassMethod::ConsumeOk(from)
    } // fn from()
} // impl From<ConsumeOk<'a>> for ClassMethod

impl<'a> From<ConsumeOk<'a>> for super::SpecMethod<'a> {
    fn from(from: ConsumeOk<'a>) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<ConsumeOk<'a>> for ::super::SpecMethod
impl<'a> ::method::basic::DeliverMethod<'a> for ::Qpid9_0 {
...
impl<'a> From<Deliver<'a>> for ClassMethod<'a> {
    fn from(from: Deliver<'a>) -> Self {
        ClassMethod::Deliver(from)
    } // fn from()
} // impl From<Deliver<'a>> for ClassMethod

impl<'a> From<Deliver<'a>> for super::SpecMethod<'a> {
    fn from(from: Deliver<'a>) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<Deliver<'a>> for ::super::SpecMethod
impl<'a> ::method::basic::GetMethod<'a> for ::Qpid9_0 {
    type Payload = Get<'a>;
} // impl<'a> ::method::basic::GetMethod<'a> for ::Qpid9_0
...
#[test]
fn test_get_encodable_bytes_written_matches_len() {
    let payload: Get = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
impl<'a> ::method::basic::GetEmptyMethod<'a> for ::Qpid9_0 {
...
impl<'a> ::Encodable for GetEmpty<'a> {
    fn encoded_size(&self) -> usize {
        0 + ::Encodable::encoded_size(&self.cluster_id)
    } // encoded_size
    fn write_encoded_to<W>(&self, writer: &mut W) -> ::std::io::Result<()>
        where W: ::std::io::Write
    {
        try!(::Encodable::write_encoded_to(&self.cluster_id, writer)); // cluster_id
...
#[test]
fn test_get_empty_encodable_bytes_written_matches_len() {
    let payload: GetEmpty = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
} // impl ::ProtocolMethodPayload for GetEmpty<'a>
...
impl<'a> From<GetEmpty<'a>> for ClassMethod<'a> {
    fn from(from: GetEmpty<'a>) -> Self {
        ClassMethod::GetEmpty(from)
    } // fn from()
} // impl From<GetEmpty<'a>> for ClassMethod

impl<'a> From<GetEmpty<'a>> for super::SpecMethod<'a> {
    fn from(from: GetEmpty<'a>) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<GetEmpty<'a>> for ::super::SpecMethod
impl<'a> ::method::basic::GetOkMethod<'a> for ::Qpid9_0 {
...
#[test]
fn test_get_ok_encodable_bytes_written_matches_len() {
    let payload: GetOk = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
impl<'a> From<GetOk<'a>> for ClassMethod<'a> {
    fn from(from: GetOk<'a>) -> Self {
        ClassMethod::GetOk(from)
    } // fn from()
} // impl From<GetOk<'a>> for ClassMethod

impl<'a> From<GetOk<'a>> for super::SpecMethod<'a> {
    fn from(from: GetOk<'a>) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<GetOk<'a>> for ::super::SpecMethod
impl<'a> ::method::basic::PublishMethod<'a> for ::Qpid9_0 {
...
impl<'a> From<Publish<'a>> for ClassMethod<'a> {
    fn from(from: Publish<'a>) -> Self {
        ClassMethod::Publish(from)
    } // fn from()
} // impl From<Publish<'a>> for ClassMethod

impl<'a> From<Publish<'a>> for super::SpecMethod<'a> {
    fn from(from: Publish<'a>) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<Publish<'a>> for ::super::SpecMethod
impl ::method::basic::QosMethod for ::Qpid9_0 {
    type Payload = Qos;
} // impl ::method::basic::QosMethod for ::Qpid9_0
...
impl ::method::basic::QosOkMethod for ::Qpid9_0 {
    type Payload = QosOk;
} // impl ::method::basic::QosOkMethod for ::Qpid9_0
...
} // impl From<QosOk> for ClassMethod

impl From<QosOk> for super::SpecMethod<'static> {
    fn from(from: QosOk) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<QosOk> for ::super::SpecMethod
impl ::method::basic::RecoverMethod for ::Qpid9_0 {
...
#[test]
fn test_recover_encodable_bytes_written_matches_len() {
    let payload: Recover = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
impl ::method::basic::RecoverSyncMethod for ::Qpid9_0 {
    type Payload = RecoverSync;
} // impl ::method::basic::RecoverSyncMethod for ::Qpid9_0
...
impl RecoverSync {
    pub fn new(requeue: bool) -> Self {
        RecoverSync { requeue: requeue } // RecoverSync
    } // fn new()
    impl_properties! {
(requeue, set_requeue) -> bool,
} // impl_properties
} // impl RecoverSync
impl Default for RecoverSync {
    fn default() -> Self {
        RecoverSync::new(false)
    } // fn default()
} // impl Default for RecoverSync

impl ::Encodable for RecoverSync {
    fn encoded_size(&self) -> usize {
        1
    } // encoded_size
    fn write_encoded_to<W>(&self, writer: &mut W) -> ::std::io::Result<()>
...
#[test]
fn test_recover_sync_encodable_bytes_written_matches_len() {
    let payload: RecoverSync = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
impl ::ProtocolMethodPayload for RecoverSync {
    fn class(&self) -> ::Class {
        ::Class::Basic
    }
    fn class_id(&self) -> u16 {
...
impl ::method::basic::SetRecoverSyncMethodFields for RecoverSync {
    fn set_requeue(&mut self, requeue: bool) {
        self.set_requeue(requeue)
    } // set_requeue()
} // impl ::method::basic::SetRecoverSyncMethodFields for RecoverSync
impl<'a> From<RecoverSync> for ClassMethod<'a> {
    fn from(from: RecoverSync) -> Self {
        ClassMethod::RecoverSync(from)
    } // fn from()
} // impl From<RecoverSync> for ClassMethod

impl From<RecoverSync> for super::SpecMethod<'static> {
    fn from(from: RecoverSync) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<RecoverSync> for ::super::SpecMethod
impl ::method::basic::RecoverSyncOkMethod for ::Qpid9_0 {
    type Payload = RecoverSyncOk;
} // impl ::method::basic::RecoverSyncOkMethod for ::Qpid9_0
...
impl Default for RecoverSyncOk {
    fn default() -> Self {
        RecoverSyncOk::new()
    } // fn default()
} // impl Default for RecoverSyncOk

impl ::Encodable for RecoverSyncOk {
    fn encoded_size(&self) -> usize {
        0
    } // encoded_size
    fn write_encoded_to<W>(&self, _: &mut W) -> ::std::io::Result<()>
...
#[test]
fn test_recover_sync_ok_encodable_bytes_written_matches_len() {
    let payload: RecoverSyncOk = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
impl ::ProtocolMethodPayload for RecoverSyncOk {
    fn class(&self) -> ::Class {
        ::Class::Basic
    }
    fn class_id(&self) -> u16 {
...
impl<'a> From<RecoverSyncOk> for ClassMethod<'a> {
    fn from(from: RecoverSyncOk) -> Self {
        ClassMethod::RecoverSyncOk(from)
    } // fn from()
} // impl From<RecoverSyncOk> for ClassMethod

impl From<RecoverSyncOk> for super::SpecMethod<'static> {
    fn from(from: RecoverSyncOk) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<RecoverSyncOk> for ::super::SpecMethod
impl ::method::basic::RejectMethod for ::Qpid9_0 {
    type Payload = Reject;
} // impl ::method::basic::RejectMethod for ::Qpid9_0
...
#[test]
fn test_reject_encodable_bytes_written_matches_len() {
    let payload: Reject = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
impl<'a> From<Reject> for ClassMethod<'a> {
    fn from(from: Reject) -> Self {
        ClassMethod::Reject(from)
    } // fn from()
} // impl From<Reject> for ClassMethod

impl From<Reject> for super::SpecMethod<'static> {
    fn from(from: Reject) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<Reject> for ::super::SpecMethod
impl<'a> ::method::basic::ReturnMethod<'a> for ::Qpid9_0 {
...
impl<'a> From<Return<'a>> for ClassMethod<'a> {
    fn from(from: Return<'a>) -> Self {
        ClassMethod::Return(from)
    } // fn from()
} // impl From<Return<'a>> for ClassMethod

impl<'a> From<Return<'a>> for super::SpecMethod<'a> {
    fn from(from: Return<'a>) -> Self {
        super::SpecMethod::Basic(from.into())
    } // fn default()
} // impl From<Return<'a>> for ::super::SpecMethod
...
impl<'a> ::Encodable for ClassMethod<'a> {
    fn encoded_size(&self) -> usize {
        match *self {
            ...
            ClassMethod::RecoverSync(ref method) => ::Encodable::encoded_size(method),
            ClassMethod::RecoverSyncOk(ref method) => ::Encodable::encoded_size(method),
...
impl<'a> ::ProtocolMethodPayload for ClassMethod<'a> {
    fn class(&self) -> ::Class {
        match *self {
            ...
            ClassMethod::RecoverSync(ref method) => ::ProtocolMethodPayload::class(method),
            ClassMethod::RecoverSyncOk(ref method) => ::ProtocolMethodPayload::class(method),
    ...
    fn class_id(&self) -> u16 {
        match *self {
            ...
            ClassMethod::RecoverSync(ref method) => ::ProtocolMethodPayload::class_id(method),
            ClassMethod::RecoverSyncOk(ref method) => ::ProtocolMethodPayload::class_id(method),
    ...
    fn class_name(&self) -> &'static str {
        match *self {
            ...
            ClassMethod::RecoverSync(ref method) => ::ProtocolMethodPayload::class_name(method),
            ClassMethod::RecoverSyncOk(ref method) => ::ProtocolMethodPayload::class_name(method),
    ...
    fn method_id(&self) -> u16 {
        match *self {
            ...
            ClassMethod::RecoverSync(ref method) => ::ProtocolMethodPayload::method_id(method),
            ClassMethod::RecoverSyncOk(ref method) => ::ProtocolMethodPayload::method_id(method),
    ...
    fn method_name(&self) -> &'static str {
        match *self {
            ...
            ClassMethod::RecoverSync(ref method) => ::ProtocolMethodPayload::method_name(method),
            ClassMethod::RecoverSyncOk(ref method) => ::ProtocolMethodPayload::method_name(method),
