...
impl<'a> ::method::message::AppendMethod<'a> for ::Qpid9_0 {
...
impl<'a> ::Encodable for Append<'a> {
    fn encoded_size(&self) -> usize {
        0 + ::Encodable::encoded_size(&self.reference) + ::Encodable::encoded_size(&self.bytes)
    } // encoded_size
    fn write_encoded_to<W>(&self, writer: &mut W) -> ::std::io::Result<()>
        where W: ::std::io::Write
    {
        try!(::Encodable::write_encoded_to(&self.reference, writer)); // reference
        try!(::Encodable::write_encoded_to(&self.bytes, writer)); // bytes
...
#[test]
fn test_append_encodable_bytes_written_matches_len() {
    let payload: Append = Default::default();
...
} // impl ::ProtocolMethodPayload for Append<'a>
...
impl<'a> ::Encodable for Cancel<'a> {
    fn encoded_size(&self) -> usize {
        0 + ::Encodable::encoded_size(&self.destination)
    } // encoded_size
    fn write_encoded_to<W>(&self, writer: &mut W) -> ::std::io::Result<()>
        where W: ::std::io::Write
    {
...
impl<'a> ::Encodable for Checkpoint<'a> {
    fn encoded_size(&self) -> usize {
        0 + ::Encodable::encoded_size(&self.reference) + ::Encodable::encoded_size(&self.identifier)
    } // encoded_size
    fn write_encoded_to<W>(&self, writer: &mut W) -> ::std::io::Result<()>
        where W: ::std::io::Write
    {
        try!(::Encodable::write_encoded_to(&self.reference, writer)); // reference
        try!(::Encodable::write_encoded_to(&self.identifier, writer)); // identifier
...
#[test]
fn test_checkpoint_encodable_bytes_written_matches_len() {
    let payload: Checkpoint = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
} // impl ::ProtocolMethodPayload for Checkpoint<'a>
...
impl<'a> ::Encodable for Close<'a> {
    fn encoded_size(&self) -> usize {
        0 + ::Encodable::encoded_size(&self.reference)
    } // encoded_size
    fn write_encoded_to<W>(&self, writer: &mut W) -> ::std::io::Result<()>
        where W: ::std::io::Write
    {
...
impl<'a> ::Encodable for Consume<'a> {
    fn encoded_size(&self) -> usize {
        3 + ::Encodable::encoded_size(&self.queue) + ::Encodable::encoded_size(&self.destination) +
...
#[test]
fn test_empty_encodable_bytes_written_matches_len() {
    let payload: Empty = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
impl ::Encodable for Offset {
    ...
    fn write_encoded_to<W>(&self, writer: &mut W) -> ::std::io::Result<()>
        where W: ::std::io::Write
    {
        try!(::Encodable::write_encoded_to(&self.value, writer)); // value
...
#[test]
fn test_offset_encodable_bytes_written_matches_len() {
    let payload: Offset = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
impl<'a> ::Encodable for Reject<'a> {
    fn encoded_size(&self) -> usize {
        2 + ::Encodable::encoded_size(&self.text)
    } // encoded_size
    fn write_encoded_to<W>(&self, writer: &mut W) -> ::std::io::Result<()>
        where W: ::std::io::Write
    {
        try!(::Encodable::write_encoded_to(&self.code, writer)); // code
        try!(::Encodable::write_encoded_to(&self.text, writer)); // text
...
} // impl ::ProtocolMethodPayload for Reject<'a>
...
impl<'a> ::Encodable for Transfer<'a> {
    fn encoded_size(&self) -> usize {
        29 + ::Encodable::encoded_size(&self.destination) +
        ...
        ::Encodable::encoded_size(&self.user_id) + ::Encodable::encoded_size(&self.app_id) +
        ...
        where W: ::std::io::Write
    {
        ...
        try!(::Encodable::write_encoded_to(&{
                                           ...
                                           writer));
        try!(::Encodable::write_encoded_to(&self.ttl, writer)); // ttl
        try!(::Encodable::write_encoded_to(&self.priority, writer)); // priority
        try!(::Encodable::write_encoded_to(&self.timestamp, writer)); // timestamp
        try!(::Encodable::write_encoded_to(&self.delivery_mode, writer)); // delivery_mode
        try!(::Encodable::write_encoded_to(&self.expiration, writer)); // expiration
        ...
        try!(::Encodable::write_encoded_to(&self.message_id, writer)); // message_id
        try!(::Encodable::write_encoded_to(&self.correlation_id, writer)); // correlation_id
        try!(::Encodable::write_encoded_to(&self.reply_to, writer)); // reply_to
        try!(::Encodable::write_encoded_to(&self.content_type, writer)); // content_type
        try!(::Encodable::write_encoded_to(&self.content_encoding, writer)); // content_encoding
        try!(::Encodable::write_encoded_to(&self.user_id, writer)); // user_id
        try!(::Encodable::write_encoded_to(&self.app_id, writer)); // app_id
        try!(::Encodable::write_encoded_to(&self.transaction_id, writer)); // transaction_id
        try!(::Encodable::write_encoded_to(&self.security_token, writer)); // security_token
        try!(::Encodable::write_encoded_to(&self.application_headers, writer)); // application_headers
        try!(::Encodable::write_encoded_to(&self.body, writer)); // body
...
#[test]
fn test_transfer_encodable_bytes_written_matches_len() {
    let payload: Transfer = Default::default();
    let expected_len = ::Encodable::encoded_size(&payload);
    let mut writer = ::std::io::Cursor::new(Vec::with_capacity(expected_len));
    ::Encodable::write_encoded_to(&payload, &mut writer).unwrap();
    let payload = writer.into_inner();
...
} // impl ::ProtocolMethodPayload for Transfer<'a>
...
impl<'a> ::ProtocolMethodPayload for ClassMethod<'a> {
    fn class(&self) -> ::Class {
        match *self {
            ClassMethod::Append(ref method) => ::ProtocolMethodPayload::class(method),
            ClassMethod::Cancel(ref method) => ::ProtocolMethodPayload::class(method),
            ClassMethod::Checkpoint(ref method) => ::ProtocolMethodPayload::class(method),
            ...
            ClassMethod::Empty(ref method) => ::ProtocolMethodPayload::class(method),
            ClassMethod::Get(ref method) => ::ProtocolMethodPayload::class(method),
            ClassMethod::Offset(ref method) => ::ProtocolMethodPayload::class(method),
            ...
            ClassMethod::Transfer(ref method) => ::ProtocolMethodPayload::class(method),
    ...
    fn class_name(&self) -> &'static str {
        match *self {
            ClassMethod::Append(ref method) => ::ProtocolMethodPayload::class_name(method),
            ClassMethod::Cancel(ref method) => ::ProtocolMethodPayload::class_name(method),
            ClassMethod::Checkpoint(ref method) => ::ProtocolMethodPayload::class_name(method),
            ...
            ClassMethod::Empty(ref method) => ::ProtocolMethodPayload::class_name(method),
            ClassMethod::Get(ref method) => ::ProtocolMethodPayload::class_name(method),
            ClassMethod::Offset(ref method) => ::ProtocolMethodPayload::class_name(method),
            ...
            ClassMethod::Transfer(ref method) => ::ProtocolMethodPayload::class_name(method),
    ...
    fn method_name(&self) -> &'static str {
        match *self {
            ClassMethod::Append(ref method) => ::ProtocolMethodPayload::method_name(method),
            ClassMethod::Cancel(ref method) => ::ProtocolMethodPayload::method_name(method),
            ClassMethod::Checkpoint(ref method) => ::ProtocolMethodPayload::method_name(method),
            ...
            ClassMethod::Empty(ref method) => ::ProtocolMethodPayload::method_name(method),
            ClassMethod::Get(ref method) => ::ProtocolMethodPayload::method_name(method),
            ClassMethod::Offset(ref method) => ::ProtocolMethodPayload::method_name(method),
            ...
            ClassMethod::Transfer(ref method) => ::ProtocolMethodPayload::method_name(method),
