...
pub mod basic {
    ...
    impl<'a> Deliver<'a> {
        pub fn new<R, E, C>(consumer_tag: C,
                            delivery_tag: u64,
                            redelivered: bool,
                            exchange: E,
                            routing_key: R)
...
pub mod connection {
    ...
    impl<'a> StartOk<'a> {
        pub fn new<L, M, C, R>(client_properties: C, mechanism: M, response: R, locale: L) -> Self
